...
--
-- Name: games winners_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT winners_fkey FOREIGN KEY (winner_id) REFERENCES public.teams(team_id);
